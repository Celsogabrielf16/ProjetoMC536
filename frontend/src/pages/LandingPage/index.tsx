  ...
  return (
    <>
      ...
      <main className="LandingPageMain">
        ...
        <section
          ref={refFirst}
          className={`first-information ${
            isVisibleFirst ? 'animeOpacity' : ''
          }`}
        >
          <h3 className="information__title">
            Ace<b className="moneyDetail">$$</b>o Fácil a Dados Públicos
          </h3>
          <p className="information__description">
            Exibir dados de forma clara permite que todos compreendam o
            andamento de projetos públicos. Na Unicamp, isso fortalece a gestão
            participativa e promove o diálogo com a sociedade, facilitando que
            qualquer cidadão fiscalize e contribua para uma gestão eficiente.
          </p>
          <div className="first-information__cards">
            {isVisibleFirst && (
              <Card
                ...
                relativeValue={cardData.relativeValue}
              />
            )}
            {isVisibleFirst && (
              <Card
